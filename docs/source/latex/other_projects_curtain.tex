\begin{figure}[hbp]
    \begin{center}
        ...
        \begin{tikzpicture}
            \begin{umlsystem}{An automated curtain which is closed when sun shines like it would be in other projects}
                \umlusecase[x=-5, y=8, text=red, draw=white, fill=white, name={protocol_bus}]{Protocol Bus}
                \umlusecase[x=-0, y=8, text=red, draw=white, fill=white, width=3cm, name={curtain_model}]{Curtain Model (a deterministic state machine)}
                ...
                \umlinherit[arg2={notify closed}, pos2=0.5]{bright}{curtain}
                ...
                \umlusecase[x=0, y=4, fill=gray!30, width=1.1cm, name={curtain2}]{OPENED}
                \umlinherit[arg2={open the curtain}, pos2=0.6]{You}{opened_message}
                \umlinherit[arg1={notify opened}, pos1=0.5]{opened_message}{curtain2}
                ...
                \umlusecase[x=0, y=2, fill=gray!30, width=1.1cm, name={curtain3}]{OPENED}
                \umlinherit[arg2={notify open}, pos2=0.6]{dark}{curtain3}
                ...
                \umlusecase[x=0, y=0, fill=gray!30, width=1.1cm, name={curtain4}]{CLOSED}
                \umlinherit[arg2={notify closed}, pos2=0.5]{bright2}{curtain4}
                \umlusecase[x=-5, y=0, fill=white, width=1.1cm, name={closed_message1}]{closed message}
                \umlinherit[arg2={write closed}, pos2=0.5]{curtain4}{closed_message1}

                \umlactor[x=-9, y=-2, draw=teal, text=teal]{You are angry!!!}

            \end{umlsystem}
        \end{tikzpicture}%
        }
        \caption{An automated curtain which is closed when sun shines, like it would be in \textbf{other projects}}
