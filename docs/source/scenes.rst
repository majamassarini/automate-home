...
At any moment you can recall the snapshot.

Using a scene is just a quick way to put every device belonging to the scene
into the state you want. You are saying to the system: hey, do not
touch the state of these devices — I'm using them.
...
Now, one of your sockets, only when Christmas time comes, is used to turn
...
You need to tell them you are going to bed.
...
The special socket will do the same until Christmas time comes.
