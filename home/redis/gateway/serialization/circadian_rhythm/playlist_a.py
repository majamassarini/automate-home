...
from home.appliance.sound.player.event.forced.circadian_rhythm.playlist_a import Event
...
KEY = "home.appliance.sound.player.event.forced.circadian_rhythm.playlist_a.Event"
