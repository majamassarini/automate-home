...
from home.appliance.socket.presence.christmas.state.on import (
    callable as on_callable,
)
...
class State(Mixin, mixin.IsOn, Parent):
    def __init__(self, events=None, events_disabled=None):
        ...
        self.forced_on = (
            home.appliance.socket.presence.christmas.state.forced.on.State
        )
        self.forced_off = (
